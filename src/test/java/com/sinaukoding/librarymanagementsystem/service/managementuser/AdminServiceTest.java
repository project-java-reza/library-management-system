...
class AdminServiceTest {
    ...
    void testCreateAdmin_Success() {
        AdminRequestRecord request = new AdminRequestRecord(
                null, "Rizqi Reza Ardiansyah", "reza", "rizqirezaardiansyah@gmail.com", "supersecret", Status.AKTIF, ERole.ADMIN
        );
    ...
    void testEditAdmin_Success() {
        AdminRequestRecord request = new AdminRequestRecord(
                "123", "Rizqi Reza Ardiansyah", "reza", "rizqirezaardiansyah@gmail.com", "passwordbaru", Status.AKTIF, ERole.ADMIN
        );
